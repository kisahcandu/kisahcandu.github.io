...
# --- Fungsi Tambahan: Edit Judul dengan Gemini AI ---
def edit_title_with_gemini(original_title, edited_content):
    ...
    prompt_title = (
        ...
        f"Judul harus singkat, maksimal 10 kata, dan langsung to the point. "
        f"Hindari judul yang terlalu kaku seperti 'Kisah Percintaan'. "
    ...
    try:
        ...
        print(f"❌ Error saat mengedit judul dengan Gemini AI: {e}. Menggunakan judul asli.")
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Panggil fungsi edit judul setelah artikel selesai diedit
        new_title = edit_title_with_gemini(post_to_publish['processed_title'], final_processed_content)
        post_to_publish['processed_title'] = new_title # Ganti judul lama dengan judul baru
        
        # Lanjutkan proses pembuatan file
